  ...
  sections: [
    {
      title: 'Overview',
      description:
        'This CMS is configured as a single workspace. Multi-workspace management is disabled until a real organization model is added.',
      links: []
    }
  ]
};
  ...
  sections: [
    {
      title: 'Overview',
      description:
        'Team management is disabled in the simple CMS auth setup. Add server-side users, roles, and permissions before enabling team features.',
      links: []
    }
  ]
};
  ...
  sections: [
    {
      title: 'Overview',
      description:
        'Billing is not configured in this CMS. Connect your preferred billing provider when paid plans are needed.',
      links: []
    }
  ]
};
